// Short Casa URL: oriz.at/c/[slug] — used for QR codes (denser, easier
// to scan from distance). Renders the same content as /casa/[slug].
...
export default async function CasaShortPage({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
