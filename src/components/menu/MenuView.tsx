  ...
  return (
    <div style={{ backgroundColor: bg, minHeight: '100vh' }}>
      <main className="max-w-3xl mx-auto px-6 pt-20 pb-8" style={cssVars}>
        ...
        <footer className="mt-24 mb-10 flex flex-col items-center gap-5">
          {(venue.instagram_url || venue.google_maps_url) && (
            <div className="flex items-center gap-5">
              {venue.instagram_url && (
                <a href={venue.instagram_url} target="_blank" rel="noreferrer"
                  ...
                  <span className="font-sans text-[10px] tracking-regal uppercase">Instagram</span>
                </a>
              )}
              {venue.google_maps_url && (
                <a href={venue.google_maps_url} target="_blank" rel="noreferrer"
                  ...
                  <span className="font-sans text-[10px] tracking-regal uppercase">Karte</span>
                </a>
              )}
            </div>
          )}
